...
| ShopLv | 被动 | 效果 | 累计被动数 |
|--------|------|------|-----------|
| 6 | shockMark | 被击砖**+25%**伤3秒 | 1 |
| 14 | residualField | 链尾电场DOT(**30%伤**×2s, 80px) | 2 |
| 22 | chainNoDecay | **每跳伤害+5%递增** | 3 |
| 26 | dualChain | 第2道闪电(**50%伤害**) | 4 |
| 30 | overload | **链末端超载爆炸AOE(×1.0, 60px)** | 5 |
...
|--------|------|---------|--------|-------------|---------|
| 1 | 20 | ×86.7 | 0 | ×1.0 | **87** |
| 10 | 24 | ×211.8 | 1 | ×3.8 | **805** |
| 20 | 25 | ×264.7 | 2 | ×14.0 | **3,706** |
| 30 | 25 | ×264.7 | 5 | ×82.4 | **21,811** |
