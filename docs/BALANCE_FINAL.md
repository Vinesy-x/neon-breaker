...
设计目标：n ≈ 1.25~1.30（标准档），使 25 点满分支后 DPS 提升 300~700 倍。

| 武器 | 总点数 | 理论总乘数 | 等效n | Lv1×乘数 | 实测DPS | 误差 |
|------|--------|-----------|-------|---------|---------|------|
| 闪电链 | 25 | 562x | 1.288 | 3,429 | 4,098 | -16% |
| 冰爆弹 | 26 | 待测 | 待测 | — | — | — |
| 穿甲弹 | 24 | 待测 | 待测 | — | — | — |
| 轰炸机 | 24 | 待测 | 待测 | — | — | — |

详细拆解见 `docs/balance-data/branch-multiplier-model.md`
...
**effectiveHits** = 链数（无衰减，每跳等伤；charge 分支使每跳递增）
