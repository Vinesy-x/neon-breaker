...
const WEAPON_TREES = {
  ...
  drone: {
    ...
    branches: {
      ...
      pierce:   { name: '穿透', desc: '子弹穿透+1目标', max: 2, requires: { damage: 2 } },
      swarm:    { name: '蜂群', desc: '无人机攻速狂暴+50%', max: 2, requires: { count: 2, fireRate: 2 } },
      shield:   { name: '护盾', desc: '无人机可挡1次伤害', max: 1, requires: { count: 3 } },
