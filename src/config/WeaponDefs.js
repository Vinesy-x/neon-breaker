...
const WEAPON_TREES = {
  ...
  drone: {
    ...
    branches: {
      ...
      superDrone: { name: '超级无人机', desc: '红色无人机,伤害+50%/+100%', max: 2, requires: null, shopGated: true },
      overcharge: { name: '过载', desc: '激光交汇每多1条+50%/+100%伤害', max: 2, requires: { count: 2, damage: 3 }, shopGated: true },
