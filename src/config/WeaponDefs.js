...
const WEAPON_TREES = {
  kunai: {
    ...
    branches: {
      ...
      aoe:         { name: '爆炸范围', desc: '+25%爆炸半径，刀身变大', max: 3, requires: null },
      ...
      homing:      { name: '追踪', desc: '飞刀追踪最近砖块', max: 2, requires: { speed: 2 } },
      chain:       { name: '连锁爆炸', desc: '被击杀砖块也会爆炸', max: 2, requires: { aoe: 2, damage: 2 } },
      giant:       { name: '巨刀', desc: '刀身+爆炸范围翻倍', max: 1, requires: { aoe: 3, pierce: 2 } },
    },
  },
  lightning: {
